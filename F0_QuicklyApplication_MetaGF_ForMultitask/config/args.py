...
model_names = ['msdnet', 'msdnet_ge','msdnet_sparse', 'IMTA_MSDNet', 'mobilenet_imagenet','msdnet_ge_gradient']
...
sdn_exp.add_argument('--sdnarch',default='vgg16',type=str,choices=['vgg16','resnet56','wideresnet32_4','mobilenet'])
...
sdn_exp.add_argument('--sparsification',default=0,type=int)
...
exp_group.add_argument('--comparedbaseline',default="/home/sunyi/MetaGF_TPAMI/tempmodel/vgg10/exp3_joint/scores.tsv",type=str)
# exp_group.add_argument('--comparedbaseline',default="/home/sunyi/MetaGF_TPAMI/tempmodel/MSDnet10/LRN_BNfusion_forwardfull_weightdecay0.0001_Inverse_deepcopy_EMA0.5_Auxlr0.42023-1-3-16-0-4/scores.tsv",type=str)
exp_group.add_argument("--EMAoldmomentum",default=0.9,type=float)
exp_group.add_argument("--Metalr",default=0.1,type=float)
exp_group.add_argument("--auxiliarylr",default=0.4,type=float)# the adjust scale of the learning rate in the auxiliary training
exp_group.add_argument("--sparsetraininglr",default=1e-6,type=float)
exp_group.add_argument("--metaWeightdecay",default=5e-5,type=float)
exp_group.add_argument('--backbonetask',default=6,type=int)
exp_group.add_argument("--MetaGFstartEpoch",default=50,type=int)
exp_group.add_argument('--usinglossscale',default=0,type=int)
exp_group.add_argument('--avgfusion',default=0,type=int)
####----parameter
...
data_group.add_argument('--data-root', metavar='DIR', default='./D1_data/cifar/',
...
arch_group.add_argument('--arch', '-a', metavar='ARCH', default='msdnet_sparse',
